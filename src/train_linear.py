...
print("Individual feature RMSEs:")
for k,v in individual_validation_errors.items():
    print("validation RMSE of feature " + k + ": " + str(v))
...
print("intuitive features linear regression RMSE: " + str(err_intuitive))
...
print("low error features linear regression RMSE: " + str(err_low_few))
...
print("forecastable features linear regression RMSE: " + str(err_predictable))
...
print("date only features linear regression RMSE: " + str(err_date))
...
print("all features linear regression RMSE: " + str(err_complete))
